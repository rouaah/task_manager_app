// ignore_for_file: prefer_interpolation_to_compose_strings, no_leading_underscores_for_local_identifiers, deprecated_member_use, prefer_typing_uninitialized_variables
...
class OurReadMore extends StatefulWidget {
  const OurReadMore(
    this.data, {
    super.key,
    this.preDataText,
...
class ReadMoreTextState extends State<OurReadMore> {
  bool _readMore = true;
          ...
          case TrimMode.length:
            if (widget.trimLength < widget.data.length) {
              textSpan = TextSpan(
                ...
                text:
                    _readMore ? widget.data.substring(0, widget.trimLength) : widget.data,
